...
const CartPageIcon = styled.div `${tw`items-center flex  justify-center mr-4  `};`
const ProductCartEntireContent = styled.div `${tw`flex overflow-auto items-start justify-end`}
transition-delay:5s;`
const HideCheckButton = styled.div `${tw`bg-gray-800 text-white p-1 text-xl `}`
...
export { ProductsCart, CartPageIcon, Icon, ProductCartEntireContent, AddSomeProductsIntoCart, HideCheckButton, NoOfProductStoreText, CartWrapper, SubTotalAndCheckButtonWrapper }
