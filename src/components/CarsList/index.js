...
class Car extends React.Component {
    ...
    render() {
        let StartAndSTartButton = <Startbutton onClick={this.onStartOrStop}>{this.state.possibleValues==="Running"?"start":"stop"}</Startbutton>
        //this.state.possibleValues=="Running"? :
